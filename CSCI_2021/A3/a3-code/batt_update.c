...
// //   int tempDisplay = *display;
// //   //BATTERY LEVELS (most significant portion)
// //   if (batt.percent >= 5)
// //     tempDisplay = 0b1 << 1; //1 shifts left 1 spot
// //
// //   if (batt.percent >= 30)
// //     tempDisplay = (tempDisplay + 0b1) << 1; //add 1 and shift left 1
// //   else
// //     tempDisplay = tempDisplay << 1; //or just shift left 1 (same pattern followed)
// //
// //   if (batt.percent >= 50)
// //     tempDisplay = (tempDisplay + 0b1) << 1;
// //   else
...
// //     tempDisplay = tempDisplay << 7; //shift left 7
// //     tempDisplay = tempDisplay + numbers[threeNums[i]]; //add number
// //   }
// //   *display = tempDisplay;
// // return 0;
// // }
...
//     return 1;
//   if(set_display_from_batt(batt, &BATT_DISPLAY_PORT) == 1) //using display function and global variable for display
//     return 1;
//   return 0;
// }
